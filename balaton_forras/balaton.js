class hal{
    constructor(fajmagyar,fajlatin,egyeb,url,kep){
        this.fajmagyar = fajmagyar;
        this.fajlatin = fajlatin;
        this.egyeb = egyeb;
        this.url = url;
        this.kep = kep;
    }
...
document.getElementById("halnevek").innerHTML= halak[hal].fajmagyar+","+halak[hal].fajmagyar
if (halak[hal].egyeb != null) {
    document.getElementById("halNevek").innerHTML+= halak[hal].egyeb;
}
document.getElementById("halUrl").title=halak[hal].fajmagyar+"wiki:"+ halak[hal].url
}
